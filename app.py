...
class DeepResearchTool:
    ...
    def configure_api(self, api_key: Optional[str] = None):
        """Configure the Gemini API with dynamic model discovery.
        
        Queries the API to discover all available models and auto-selects
        the best one. Falls back to a static cascade if discovery fails.
        Get your free API key at: https://aistudio.google.com/app/apikey
        """
        if not api_key:
            api_key = os.environ.get("GEMINI_API_KEY") or os.environ.get("GOOGLE_API_KEY") or os.environ.get("VITE_GEMINI_API_KEY") or "AIzaSyAmFPeaoBow1mHG0bnZG4y_6QkqN98e4oo"
